    ...
    env.update(
        {
            ...
            "RL_DEVELOPER_MEMORY_SERVER_ENFORCE_PARENT_SINGLETON": "0",
            "RL_DEVELOPER_MEMORY_SERVER_PARENT_INSTANCE_IDLE_TIMEOUT_SECONDS": "0",
            "RL_DEVELOPER_MEMORY_SERVER_PARENT_INSTANCE_MONITOR_INTERVAL_SECONDS": "0.25",
    ...
    with patched_env(
        {
            ...
            "RL_DEVELOPER_MEMORY_SERVER_ENFORCE_PARENT_SINGLETON": base_env["RL_DEVELOPER_MEMORY_SERVER_ENFORCE_PARENT_SINGLETON"],
            "RL_DEVELOPER_MEMORY_SERVER_PARENT_INSTANCE_IDLE_TIMEOUT_SECONDS": base_env["RL_DEVELOPER_MEMORY_SERVER_PARENT_INSTANCE_IDLE_TIMEOUT_SECONDS"],
            "RL_DEVELOPER_MEMORY_SERVER_PARENT_INSTANCE_MONITOR_INTERVAL_SECONDS": base_env["RL_DEVELOPER_MEMORY_SERVER_PARENT_INSTANCE_MONITOR_INTERVAL_SECONDS"],
