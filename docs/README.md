...
- [MCP_STABILITY.md](MCP_STABILITY.md) — migration atomicity, destructive migration guardrails, pure-read lifecycle status, strict read-only retrieval, and backup/restore safety
